...
<template>
  <header>
    <div class="nav-links">
      <router-link
        :to="{ name: 'promociones' }"
        :class="{ 'router-link-active': isRouteActive('/promociones') }"
    ...
    <div class="nav-links">
      <router-link
        :to="{ name: 'cartelera' }"
        :class="{ 'router-link-active': isRouteActive('/cartelera') }"
    ...
    <div v-else class="nav-links">
      <router-link
        :to="{ name: 'reservas' }"
        :class="{ 'router-link-active': isRouteActive('/reservas') }"
      >
        MIS RESERVAS
      </router-link>
    </div>
    ...
    <div class="overlay" id="mobile-menu">
      ...
      <div class="overlay-content" style="height: 100%">
        ...
        <div v-if="!this.usrStore.isLogged" class="overlay-option">
          <router-link :to="{ name: 'registro' }" @click="closeNavMenu">
            REGISTRARSE
          </router-link>
          <router-link :to="{ name: 'login' }" @click="closeNavMenu">
            INICIAR SESION
          </router-link>
        </div>
