  ...
  <div v-else class="container_borde borde_doble">
    ...
    <div class="container_detalles margen1">
      ...
      <div class="botones">
        ...
        <button type="submit" class="btn_basic activado"> Funciones Programadas </button>

        <button type="submit" class="btn_basic" @click="navegar('programarFunciones')">Programar Funciones</button>
    ...
    <div class="container_detalles margen2">
      <div class="botones">
        <button class="btn_basic btn_fecha" @click="cambiarFecha(-1)"> Siguente</button>
        ...
        <button class="btn_basic btn_fecha" @click="cambiarFecha(1)"> Anterior</button>
      </div>
    </div>

    <div v-for="funcion in this.funcionesDeFechaSeleccionada" class="container_detalles margen2 resaltable">
      <span> Funcion #{{ funcion.idFuncion }} | Horario {{ funcion.horario }} | {{
