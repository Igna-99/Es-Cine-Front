<template>
    ...
    <div v-else class="container_borde borde_doble">
        ...
        <div class="container_detalles" style="margin-top: 20px;">
            ...
            <button type="submit" class="btn_basic opcion" @click="navegar('administrarUsuarios')">Administrar
                Usuarios</button>

            <button type="submit" class="btn_basic opcion" @click="navegar('funcionesProgramadas')">Administrar Funciones</button>

            <button type="submit" class="btn_basic opcion" @click="">Administrar
                Peliculas</button>

            <button type="submit" class="btn_basic opcion" @click="navegar('detallesUsuario')">Regresar</button>
        </div>
